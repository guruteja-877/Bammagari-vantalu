...
export default function GunturCard() {
  ...
  if (!dish) {
    return (
      <main className="flex min-h-screen w-full items-center justify-center bg-[#110D0B] px-5">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 font-dMSans text-[#A8978F]">
            Please select a dish from Guntur Cuisine.
          </p>

          <button
            type="button"
            onClick={() => navigate("/menu/all-regions/guntur")}
            className="mt-8 cursor-pointer rounded-xl bg-[#D4AF37] px-8 py-4 font-dMSans font-bold text-[#111] transition-all hover:bg-[#E5C65A]"
          >
            GO TO GUNTUR CUISINE
          </button>
  ...
  return (
    <main className="min-h-screen w-full bg-[#110D0B] px-5 py-10 sm:px-8 md:px-12 lg:px-20">
      ...
      <button
        type="button"
        onClick={() => navigate("/menu/all-regions/guntur")}
        className="mb-8 flex cursor-pointer items-center gap-2 font-dMSans text-sm font-semibold text-[#D4A359] transition-all hover:text-[#E5C65A]"
      >
        ← BACK TO GUNTUR
      </button>
        ...
        <div className="flex w-full flex-col justify-center gap-6 lg:w-1/2">
          ...
          <div className="flex w-full items-center gap-4">
            ...
            >
              ...
              >
                <path
                  d="M1.70801 1.70801H3.37467L5.59134 12.0585C5.67266 12.4376 5.88357 12.7765 6.18777 13.0168C6.49197 13.2571 6.87043 13.3839 7.25801 13.3753H15.408C15.7873 13.3746 16.1551 13.2446 16.4505 13.0068C16.746 12.7689 16.9515 12.4373 17.033 12.0669L18.408 5.87488H4.26634M7.49984 17.5006C7.49984 17.9609 7.12674 18.334 6.6665 18.334C6.20627 18.334 5.83317 17.9609 5.83317 17.5006C5.83317 17.0404 6.20627 16.6673 6.6665 16.6673C7.12674 16.6673 7.49984 17.5006ZM16.6665 17.5006C16.6665 17.9609 16.2934 18.334 15.8332 18.334C15.3729 18.334 14.9998 17.9609 14.9998 17.5006C14.9998 17.0404 15.3729 16.6673 16.6665 17.5006Z"
                  stroke="#111111"
                  strokeWidth="2"
                  strokeLinecap="round"
                />
            ...
            <button
              type="button"
              className="flex h-[58px] w-[58px] shrink-0 cursor-pointer items-center justify-center rounded-xl border border-[#3A3428] bg-[#1A1917] transition-all hover:border-[#D4AF37]"
            >
      ...
      <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-10 lg:flex-row lg:gap-20">
        ...
        <div className="flex w-full flex-col gap-4">
          ...
          <p className="pt-3 font-dMSans text-sm font-semibold text-[#F3E5AB]">
            ✓ Authentic Guntur recipe prepared with traditional ingredients.
          </p>
